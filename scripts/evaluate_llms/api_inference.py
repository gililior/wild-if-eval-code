...
from scripts.arena_filtering.classify_constrained_generation_tasks import ConstrainedGenerationClassification
import json
...
if __name__ == '__main__':
    ...
    parser.add_argument("--API_endpoint", default="https://api.openai.com/v1",
                        help="OpenAI-compatible chat completions endpoint. "
                             "If your endpoint embeds the model name, include a {} placeholder.")
    ...
    dataset = NewData(args.data)

    generator = InitGenerationsAPI(dataset, args.model, args.API_endpoint, args.API_key_name,
                                   max_new_tokens=1000)
