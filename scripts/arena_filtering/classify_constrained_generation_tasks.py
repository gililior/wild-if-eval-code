...
from scripts.arena_filtering.constants import FILTER_PROMPT, LMSYS_NAME_IN_HUB, LMSYS_SPLIT, ERROR_SCORE
from scripts.arena_filtering.heuristic_filtering import leave_only_first_request
...
if __name__ == '__main__':
    ...
    parser.add_argument("--path_to_filtered_ids", required=True,
                        help="JSON file with the filtered conversation IDs from heuristic_filtering")
    parser.add_argument("--out_dir", required=True)
    parser.add_argument("--classification_model", required=True,
    ...
    classifier = ConstrainedGenerationClassification(dataset, args.classification_model,
